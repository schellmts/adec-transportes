  ...
  return (
    <div className='w-full text-dark'>
      ...
      <div className='grid grid-cols-4 gap-5'>
        {data.map((item, index) => (
          <div style={{ backgroundImage: `url(${item.background})`, }} className='w-full hover:scale-105 duration-500 text-[#f2f2f2] text-xl flex flex-col items-start justify-end p-5 font-semibold h-64 rounded-lg bg-cover' key={index}>
            {item.title}
            <div>
